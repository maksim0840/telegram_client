...
-----------
Пункты 1-6 предполагают добавление новой папки lib_extension в проект telegram и добавлением 3-ёх строчек в файл input_field.cpp (1 строчка - включение дополнения через include, 2 строчка - функция шифровки сообщения для отправки простого сообщения и для его ответа в методе send, 3 строчка - функция шифровки сообщения для редактирования сообщения в методе prepareTextForEditMsg) и ещё 2-ух строек в файл send_files_box.cpp (1 строчка - включение дополнения через include, 2 строчка - функция шифровки сообщения для отправки простого сообщения send)
-----------
